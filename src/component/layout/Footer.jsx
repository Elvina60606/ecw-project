    ...
    <div className="bg-primary-800">
      <div className="container py-8 d-flex flex-column flex-lg-row align-items-center justify-content-between">
        ...
        <div className="d-flex flex-column align-items-center align-items-lg-end">
          <div className="mb-4">
            <a href="#">
              <img src='https://raw.githubusercontent.com/Elvina60606/Onon_cake_React/b7d4258906d9bffb3ea738abedf479fb6fdb1ce4/src/assets/images/facebookWhite.svg'
                alt="facebook-white"
                className="border border-white rounded-circle p-2 me-2" />
            </a>
            <a href="#">
              <img src='https://raw.githubusercontent.com/Elvina60606/Onon_cake_React/b7d4258906d9bffb3ea738abedf479fb6fdb1ce4/src/assets/images/instagramWhite.svg' 
                alt="instagram-white"
                className="border border-white rounded-circle p-2 me-2" />
            </a>
            <a href="#">
              <img src='https://raw.githubusercontent.com/Elvina60606/Onon_cake_React/b7d4258906d9bffb3ea738abedf479fb6fdb1ce4/src/assets/images/lineWhite.svg'
                alt="line-white"
