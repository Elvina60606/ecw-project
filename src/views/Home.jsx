    ...
    <>
      ...
      <section className="story-container">
        <div className="story-content text-primary-800">
          ...
          <p className="mb-4">
            2020年，從日本結束兩年的甜點研習後回到台灣，心中始終懷抱著一個小小夢想
            —— 擁有一家屬於自己的甜點店。於是，ONON CAKE 二溫菓子 誕生了。
          </p>
        ...
        <img className="cake-img" alt="杯子蛋糕" src={images.cake} />
        <img className="cake2-img" alt="切片蛋糕" src={images.cake2} />
        <img className="cake3-img" alt="法國麵包" src={images.cake3} />
        <img
          className="vector11-img"
          alt="裝飾向量圖案1"
          src={images.vector1}
        />
        <img className="vector2-img" alt="裝飾向量圖案2" src={images.vector2} />
        <img className="vector3-img" alt="裝飾向量圖案3" src={images.vector3} />
        <img
          className="rectangle303-img"
          alt="背景波浪圖案"
