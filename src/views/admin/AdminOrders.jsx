...
import { getAsyncAdminOrders, setCurrentPage, deleteAsyncOrder, setAdminOrder, updateAsyncOrder } from "../../slices/admin/adminOrderSlice";
...
const AdminOrders =() =>{
    ...
    const { adminOrders, pagination, currentPage } = useSelector( state => state.adminOrders);
