      ...
      <section className="container pt-8 pb-5">
        ...
        <nav className="my-breadcrumb" aria-label="breadcrumb">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item">
              <Link to="/products_sidebar_layout/products">商品介紹</Link>
            </li>
        ...
        <div className="row">
          ...
          <div className="col-lg-7 order-3 ps-lg-8">
            ...
            <p className="text-primary-700 mb-4 mb-lg-6">
              {product.description}
            </p>
            <div className="d-flex align-items-baseline">
              <span className="fs-3 text-secondary-500 fw-bold me-6 mb-4 mb-lg-6">
                NT$ {product.price}
              </span>
              <span className="text-decoration-line-through text-gray-700 fs-7">
                原價 NT$ {product.origin_price}
              </span>
            </div>
            <div className="mb-5 mb-lg-0">
              <span className="badge text-bg-secondary-50 text-secondary-500 p-2 fs-6 rounded-1 fw-500 border border-1 border-secondary-500">
                此商品為冷凍寄出
              </span>
            </div>
            ...
            <div className="cart-actions-mobile d-lg-none fixed-bottom px-3 py-4 bg-white shadow">
              ...
              <div
                className={`bg-white py-1 px-2 rounded ${showMobileControl ? "" : "d-none"}`}
              >
                <div className="d-flex align-items-center justify-content-between mb-4">
